...
They are joined by a shared **data contract** (`@nomadpath/contract`): the pipeline validates its output against it; the UI trusts it.
...
- [Data contract](architecture/data-contract.md) — the format that joins pipeline and UI.
