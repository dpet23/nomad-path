...
- [ ] Epic 10: Preprocessing & watcher test remediation — analysis-first, two-phase, multi-session. Plan: `~/.claude/plans/epic10-preprocessing-watcher-tests.md`. Phase 1 analysis at `docs/test-analysis/preprocessing-watcher-2026-04-28.md`. Phase 1.5 closed 2026-04-28 with **tests-only** contract decision; **superseded 2026-05-02** by Epic 11 (schema as shared contract). Sessions B and C **paused pending contextless triage** against what Epic 11 absorbs. Escaped-bug log at `docs/test-analysis/escaped-bugs.md` accumulates evidence for any future restructure decision. Old monolithic plan preserved at `~/.claude/plans/epic10-testing-remediation-superseded-2026-04-27.md`.
...
- Epic 10 Phase 2 paused 2026-05-02. Phase 1.5's tests-only contract rule was superseded by Epic 11 (schema as shared contract) after each test-design loop revealed a new shape of preprocessing-vs-library spec drift. Sessions B and C of Epic 10 await a contextless triage session that decides which gaps remain after Epic 11's enforcement.
